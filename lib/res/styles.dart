...
class PageStyle {
  ...
  static var ts_1B72EC_18sp = TextStyle(
    fontSize: 18.sp,
    color: Color(0xFF1B72EC),
  );
  ...
  static var ts_418AE5_16sp = TextStyle(
    color: Color(0xFF418AE5),
    fontSize: 16.sp,
  );
  ...
  static var ts_blue_10sp = TextStyle(
    fontSize: 10.sp,
    color: Colors.blue,
  );
  static var ts_blue_12sp = TextStyle(
    fontSize: 12.sp,
    color: Colors.blue,
  );
  static var ts_blue_14sp = TextStyle(
    fontSize: 14.sp,
    color: Colors.blue,
  );
  static var ts_blue_16sp = TextStyle(
    fontSize: 16.sp,
    color: Colors.blue,
  );
  static var ts_blue_18sp = TextStyle(
    fontSize: 18.sp,
    color: Colors.blue,
  );
  static var ts_blue_20sp = TextStyle(
    fontSize: 20.sp,
    color: Colors.blue,
  );
}
